...
const Feature: React.FC<FeatureProps> = ({ icon, title, description, count }) => {
  return (
    <div className="p-6 bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 group relative overflow-hidden animate-scale-in">
      <div className="flex items-start">
        <div className="bg-primary/10 p-3 rounded-lg mr-4 transition-all duration-300 group-hover:bg-primary/20">
          <i className={`${icon} text-primary text-2xl group-hover:animate-bounce-slow`}></i>
        </div>
        <div>
          {count && (
            <span className="text-3xl sm:text-4xl font-bold text-gray-900 block mb-1 animate-pulse-slow">{count}</span>
          )}
          <h3 className="text-xl font-bold font-poppins">{title}</h3>
          <p className="text-gray-600 mt-2">{description}</p>
        </div>
      </div>
      <div className="absolute bottom-0 left-0 right-0 h-1 bg-primary transform scale-x-0 transition-transform duration-300 origin-left group-hover:scale-x-100"></div>
    </div>
  );
};
    ...
    <section id="about" className="py-16 md:py-28 bg-light relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-3xl mx-auto text-center mb-16">
          <span className="bg-primary/10 text-primary px-4 py-1.5 rounded-full text-sm font-semibold tracking-wide mb-3 inline-block animate-fade-in">
            ABOUT US
          </span>
          <h2 className="text-3xl md:text-5xl font-bold text-gray-900 font-poppins mb-6 animate-slide-up">
        ...
        <div className="flex flex-col lg:flex-row items-center bg-white rounded-2xl shadow-xl overflow-hidden">
          <div className="lg:w-1/2 relative">
            <div className="bg-gradient-to-r from-primary/30 to-primary/10 h-full w-full p-8 flex items-center justify-center">
              <div className="bg-white/90 backdrop-blur-sm p-8 rounded-xl shadow-lg text-center animate-scale-in">
                <div className="w-20 h-20 rounded-full bg-primary/10 flex items-center justify-center text-primary text-3xl mx-auto mb-4 animate-float">
                  <i className="fas fa-star animate-spin-slow"></i>
                </div>
                <h3 className="text-2xl font-bold text-gray-900 mb-2 animate-fade-in delay-100">Premium Quality</h3>
                <p className="text-gray-700 animate-fade-in delay-200">Our commitment to excellence ensures spotless results every time.</p>
              </div>
            </div>
          </div>
          ...
          <div className="lg:w-1/2 p-8 md:p-12">
            ...
            <div className="space-y-6">
              <div className="flex animate-slide-in-left">
                <div className="flex-shrink-0 w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center mr-4 animate-pulse-slow">
              ...
              <div className="flex animate-slide-in-left delay-100">
                <div className="flex-shrink-0 w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center mr-4 animate-pulse-slow">
              ...
              <div className="flex animate-slide-in-left delay-200">
                <div className="flex-shrink-0 w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center mr-4 animate-pulse-slow">
              ...
              <div className="flex animate-slide-in-left delay-300">
                <div className="flex-shrink-0 w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center mr-4 animate-pulse-slow">
